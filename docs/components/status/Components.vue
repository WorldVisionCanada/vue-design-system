<template>
  <div class="component-status">
    <ul class="status-list">
      <li>
        <WvcIcon name="ready" fill="#7cb518" size="small"/>
        <p>Ready</p>
      </li>
      <li>
        <WvcIcon name="review" :fill="tokens.color_ucla_gold.value" size="small"/>
        <p>Under review</p>
      </li>
      <li>
        <WvcIcon name="deprecated" :fill="tokens.color_vermilion.value" size="small"/>
        <p>Deprecated</p>
      </li>
      <li>
        <WvcIcon name="prototype" :fill="tokens.color_bleu_de_france.value" size="small"/>
        <p>Prototype</p>
      </li>
      <li>
        <span>—</span>
      ...
      <tbody>
        <tr v-for="(component, index) in components" :key="index" class="component">
          ...
          <td v-if="component.status">
            <WvcIcon v-if="component.status === 'ready'" name="ready" fill="#7cb518" size="small"/>
            <WvcIcon
